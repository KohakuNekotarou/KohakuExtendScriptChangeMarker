...
//DECLARE_PMID(kClassIDSpace, kKESCMBoss, kKESCMPrefix + 5)
//DECLARE_PMID(kClassIDSpace, kKESCMBoss, kKESCMPrefix + 5)
...
//DECLARE_PMID(kImplementationIDSpace, kKESCMImpl, kKESCMPrefix + 3)
//DECLARE_PMID(kImplementationIDSpace, kKESCMImpl, kKESCMPrefix + 4)
